...
class Display:
    ...
    def show_face(self, side, colours=[]):
        ...
        y_start = 27                                       # y coordinate for face top-left corner
        d = int(h-y_start)/2.5                             # facelet square side
        x_start = w-10-2*d                                 # x coordinate for face top-left corner
        gap = 3                                            # gap betwen the facelets border and facelets coloured part
        ...
        for i in range(2):                                 # iteration over rows
            ...
            for j in range(2):                             # iteration over columns
                ...
                if len(colours)==4:                        # case colour is provided
                ...
                if j == 1: y = y+d                         # once at the third column the row is incremented
                fclt+=1
    ...
    def test2_display(self):
        ...
        colors=('white', 'blue', 'yellow', 'green', 'red', 'orange')  # URF colours sequence in Western Rubik's cube
        for f in range(6):                                            # iteration over 6 (six cube's faces)
            ...
            for i in range(4):                                        # iteration over 4 (none cube's face facelets)
