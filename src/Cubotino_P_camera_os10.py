...
# This file is imported by Cubotino_P.py
#
#############################################################################################################
"""
...
class Camera:
    ...
    def set_gains(self, debug, a_gain, d_gain, awb_gains):
        import Cubotino_P_set_picamera_gain as camera_set_gains  # script that allows to fix some parameters at picamera
